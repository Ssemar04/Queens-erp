...
const TYPE_COLOR: Partial<Record<LocationType, string>> = {
  ...
  return (
    <div role="treeitem" aria-expanded={hasChildren ? expanded : undefined}>
      ...
      >
        ...
        <Badge variant="outline" className={cn("shrink-0 text-[10px]", TYPE_COLOR[node.type] ?? "bg-muted text-muted-foreground")}>
