...
const SIDEBAR_WIDTH = "var(--sidebar-width-fluid)"
const SIDEBAR_WIDTH_ICON = "var(--sidebar-width-icon-fluid)"
const SIDEBAR_WIDTH_MOBILE = "var(--sidebar-width-mobile-fluid)"
      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex min-h-[var(--svh-safe,100svh)] w-full has-[[data-variant=inset]]:bg-sidebar",
              className
            )}
            ref={ref}
            {...props}
...
>(
  (
    ...
    const showMobileSheet = isMobile || isTablet
    ...
    return (
      ...
      >
        <div
          className={cn(
            "relative w-[--sidebar-width] bg-transparent sidebar-width-transition",
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-[var(--svh-safe,100svh)] w-[--sidebar-width] sidebar-width-transition md:flex",
            side === "left"
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "group-data-[state=collapsed]:after:bg-sidebar-primary/30 animate-sidebar-rail-pulse",
...
const SidebarInset = React.forwardRef<
  ...
  React.ComponentProps<"main"> & {
    /** Padding size for page content inside the inset */
    paddingSize?: "sm" | "md" | "lg"
  }
>(({ className, paddingSize = "md", ...props }, ref) => {
  return (
    <main
      ref={ref}
